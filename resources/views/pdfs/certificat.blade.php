    ...
    <div class="certificat-container bg-white">
        ...
        <div class="text-lg leading-relaxed mt-10">
            ...
            <div class="p-6 rounded-lg mt-6 shadow-sm border border-gray-200">
                ...
                <p class="mb-2"><strong>Né(e) le :</strong>
                    {{ \Carbon\Carbon::parse($certificat->habitant->date_naissance)->format('d/m/Y') }} à
                    {{ $certificat->habitant->lieu_naissance }}</p>
                <p class="mb-2"><strong>Adresse :</strong> {{ $certificat->habitant->maison->adresse }}</p>
            ...
            <p class="mt-8">
                ...
                {{ $certificat->habitant->maison->quartier->nom }},
                Commune de Diass.
            </p>
            <p class="mt-6">
        ...
        <div class="flex justify-between mt-24">
            <div class="text-lg text-center">
                <p>
                    Fait à {{ $config['nom_commune'] }}, le {{ \Carbon\Carbon::now()->locale('fr')->isoFormat('D MMMM Y') }}
                </p>
            </div>
            <div class="text-center">
