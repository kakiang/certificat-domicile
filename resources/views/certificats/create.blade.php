<x-app-layout>
       <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-md border border-gray-100">
            ...
            <form method="POST" action="{{ route('certificats.store') }}" enctype="multipart/form-data" class="px-6 py-6">
                @csrf

                <div>
                    <x-input-label for="habitant_id" :value="__('Demandeur')" />
                    <x-select-input name="habitant_id" id="habitant_id">
                        <option value="" disabled selected hidden>Selectionnez le démandeur du certificat</option>
